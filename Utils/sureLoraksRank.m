function [rank,minMSE,estMSE] = sureLoraksRank(s, stdev, calmatDim)
% Function to find best rank for loraks matrix based on SURE
% Code modified from svWeightsSURE.m of Auto-ESPIRiT Master
